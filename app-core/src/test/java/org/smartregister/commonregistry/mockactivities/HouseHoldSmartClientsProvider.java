...
//        AllCommonsRepository householdrep = org.org.smartregister.Context.getInstance().allCommonsRepositoryobjects("ec_household");
//        CommonPersonObject householdobject = householdrep.findByCaseID(pc.entityId());
//
//        DetailsRepository detailsRepository = org.org.smartregister.Context.getInstance().detailsRepository();
