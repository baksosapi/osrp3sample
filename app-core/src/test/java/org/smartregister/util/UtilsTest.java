...
public class UtilsTest extends BaseUnitTest {
    ...
    public void assertConvertDateFormatTestReturnsDate() throws Exception {
        Assert.assertEquals("20-10-2017", Utils.convertDateFormat("2017-10-20", true));
        Assert.assertEquals("", Utils.convertDateFormat("20171020", true));
    }
    ...
    public void assertToDateReturnsDate() throws Exception {
        ...
        Assert.assertNotNull(Utils.toDate("2017-10-20", true));
        Assert.assertNull(Utils.toDate("20171020", true));
        Assert.assertEquals(date, Utils.toDate("2017-10-20", true));
    }

    @Test
    public void assertConvertDateFormat() throws Exception {
        Assert.assertEquals("20-10-2017", Utils.convertDateFormat("2017-10-20", "abcdxyz", true));
        Assert.assertEquals("abcdxyz", Utils.convertDateFormat("20171020", "abcdxyz", true));
        Assert.assertEquals("", Utils.convertDateFormat("20171020", "", true));
    }
    ...
    public void assertConvertDateFormatReturnsDate() throws Exception {
        ...
        Assert.assertEquals("01-01-1970", Utils.convertDateFormat(dateTime));
    }

    @Test
    public void assertConvertDateTimeFormatReturnsDate() throws Exception {
        Assert.assertEquals("24-07-1985 00:00:00", Utils.convertDateTimeFormat("1985-07-24T00:00:00.000Z", true));
//        org.junit.Assert.assertEquals("", Utils.convertDateTimeFormat("19850724", true));
    ...
    public void assertFillValueFromHashMapReturnsValue() {
        ...
        Assert.assertEquals("2017-10-20", view.getText());
        map.put(field, "");
        Utils.fillValue(view, map, field, "default", true);
        Assert.assertEquals("default", view.getText());
    }
