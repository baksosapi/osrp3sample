package org.smartregister.bidan.activities;
...
//        findViewById(R.id.btn_videos).setOnClickListener(onButtonsClickListener);
        ...
        ecRegisterClientCountView = findViewById(R.id.txt_kartu_ibu_register_client_count);
        kartuIbuANCRegisterClientCountView = findViewById(R.id.txt_kartu_ibu_anc_register_client_count);
        kartuIbuPNCRegisterClientCountView = findViewById(R.id.txt_kartu_ibu_pnc_register_client_count);
        anakRegisterClientCountView = findViewById(R.id.txt_anak_client_count);
        kohortKbCountView = findViewById(R.id.txt_kohort_kb_register_count);
    }
